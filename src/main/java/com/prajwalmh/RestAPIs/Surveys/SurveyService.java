...
public class SurveyService {
    ...
    public Survey retrieveSurveyById(String id) {
        ...
        Optional<Survey> first = surveys.stream().filter(predicate).findFirst();
    ...
    public Question retrieveSpecificSurveyQuestions(String id, String questionId) {
        List<Question> surveyQuestions = retrieveAllSurveyQuestions(id);
